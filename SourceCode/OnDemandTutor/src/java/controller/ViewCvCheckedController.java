 ...
 * @author ADMIN
 */
@WebServlet(name = "ViewCvCheckedController", urlPatterns = {"/ViewCvCheckedController"})
public class ViewCvCheckedController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (Connection connection = DBUtils.getConnection()) {
            ...
            if (modId != null) {
                List<CvDTO> cvList = modDAO.getTutorCheckedByActiveStatusAndModId("đã kiểm duyệt", modId);
        ...
        request.getRequestDispatcher("/view_checkedcv.jsp").forward(request, response);
    }
