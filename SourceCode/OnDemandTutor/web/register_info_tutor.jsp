            ...
            <<div class="container">
                <div class="form-section">
                    ...
                    <form action="UpdateTutorInfoController" method="post" >
                        ...
                        <input type="text" id="gender" name="gender" value="<%= request.getAttribute("gender")%>" required=""/>

                        <label for="experience">Experience:</label>
                        <input type="text" id="experience" name="experience" value="<%= request.getAttribute("experience")%>" required=""/>
