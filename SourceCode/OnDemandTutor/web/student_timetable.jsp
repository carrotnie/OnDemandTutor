    ...
    <table>
        ...
        <%
            ...
            if (timeTables != null) {
                    ...
                    for (int dayIndex = 0; dayIndex < daysOfWeek.length; dayIndex++) {
                        ...
                        for (TimeTableDTO timeTable : timeTables) {
                            ...
                            if (timeTable.getDayOfSlot().equals(day) && timeSlot.equals(timeRange)) {
                                ...
                                out.print("<form method='get' action='complaints.jsp' class='report-form'>");
                                out.print("<input type='hidden' name='tutorId' value='" + timeTable.getTutorId() + "'>"); // Ensure tutorId is set
                                out.print("<input type='hidden' name='studentId' value='" + timeTable.getStudentId() + "'>");
                                out.print("<input type='hidden' name='slotId' value='" + timeTable.getSlotId() + "'>"); // Ensure slotId is set
                                out.print("<input type='hidden' name='subjectName' value='" + timeTable.getSubjectName() + "'>");
                                out.print("<input type='hidden' name='tutorName' value='" + timeTable.getTutorName() + "'>");
                                out.print("<input type='hidden' name='timeRange' value='" + timeSlot + "'>");
                                out.print("<input type='hidden' name='startDate' value='" + startDate + "'>");
                                ...
                                out.print("<button type='submit' class='report-btn' data-url='complaints.jsp'>Báo Cáo</button>");
                                out.print("</form>");
                ...
                out.print("<tr><td colspan='8'>Không có dữ liệu thời khóa biểu.</td></tr>");
            }
        %>
    </table>
