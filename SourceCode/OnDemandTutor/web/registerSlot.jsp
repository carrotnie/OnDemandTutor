        ...
        <div class="container">
            ...
            <form action="MainController" method="post" accept-charset="UTF-8">
                ...
                <div class="button-container">
                    <button type="button" class="btn-add-row" onclick="addRow()">Add Slot</button>
                    <button type="submit" name="action" value="RegisterSlot" class="btn-submit">Register</button>
                    <a href="RegisterMenuController" class="btn-back">Back to Register Menu</a>
                </div>
            </form>
